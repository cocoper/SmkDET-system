...
class SimulatorModel():
    ...
    def load_model(self,model_file):  # load model
        with open(model_file, 'rb') as f:
            predictor = pickle.load(f)
        return predictor


    def ReadInputs(self,inputs_file):
    ...
    def check_status(self,parameter_list):  # 检查所有输入数据是否正确
        pass


    def read_sd(self,data_path):
        pass


    def print_results(self,summary, data_path='test_result.csv'):
    ...
    def SetArrMethod(self,method):
        self.SimPara['method'] = method
